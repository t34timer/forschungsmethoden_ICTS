...
\usepackage[
    title={Classification of Information From Issue Tracking Systems},
    author={Benedikt Kersjes, Bernhard Wetzel, Christopher Völker, Gerd Matheis, Marvin Wyrich, Nazli Olcay Kaya,\\ Steven Großmann},
    type=proposal,
    institute=iste,
    course=se,
    examiner={Dr.-Ing.\ André van Hoorn},
    supervisor={Jasmin Ramadani,\ M.Sc.},
